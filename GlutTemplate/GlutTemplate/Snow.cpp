...
//	for (int i = 0; i < 6; i++)
//	{
//		point[i].x = R * cos(PI / 2 + i * 2 * PI / 6);
//		point[i].y = R * sin(PI / 2 + i * 2 * PI / 6);
//	}
//	point[6] = lineIntersection(point[0], point[2], point[1], point[5]);
//	point[7] = lineIntersection(point[0], point[2], point[1], point[3]);
//	point[8] = lineIntersection(point[4], point[2], point[1], point[3]);
//	point[9] = lineIntersection(point[4], point[2], point[3], point[5]);
//	point[10] = lineIntersection(point[5], point[3], point[0], point[4]);
//	point[11] = lineIntersection(point[0], point[4], point[1], point[5]);
//}
//static void init() {
...
//	glVertex2f(point[10].x, point[10].y);
//	glVertex2f(point[5].x, point[5].y);
//	glVertex2f(point[11].x, point[11].y);
//	glEnd();
//	glFlush();
//}
